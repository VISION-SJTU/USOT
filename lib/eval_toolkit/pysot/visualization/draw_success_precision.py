...
def draw_success_precision(success_ret, name, videos, attr, precision_ret=None,
    ...
    # if name == 'LaSOT':
    #     plt.savefig("/home/jlzheng/doc/iccv/lasot_success.png", dpi=300)
    plt.show()
    ...
    if precision_ret:
        ...
        for idx, (tracker_name, pre) in \
            ...
            value = [v for k, v in precision_ret[tracker_name].items() if k in videos]
            plt.plot(thresholds, np.mean(value, axis=0),
                    color=COLOR[idx_tracker[tracker_name]], linestyle=LINE_STYLE[idx_tracker[tracker_name]],
        ...
        ax.set_aspect((xmax - xmin)/(ymax-ymin))
        # if name == 'LaSOT':
        #     plt.savefig("/home/jlzheng/doc/iccv/lasot_precision.png", dpi=300)
        plt.show()
    ...
    if norm_precision_ret:
        ...
        ax.set_aspect((xmax - xmin)/(ymax-ymin))
        # if name == 'LaSOT':
        #     plt.savefig("/home/jlzheng/doc/iccv/lasot_normp.png", dpi=300)
        plt.show()
