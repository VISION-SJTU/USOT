...
parser.add_argument('--output_dir', type=str,
                    default='/home/jlzheng/dataset/tracking/usot/VID_flow/', help='your vid anno file output dir')
...
vid = json.load(open(args.anno_file.format(args.bbox), 'r'))
