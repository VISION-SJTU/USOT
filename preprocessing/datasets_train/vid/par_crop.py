...
parser.add_argument('--input_dir', type=str, default='/data/dataset/ILSVRC_VID', help='your vid data dir')
parser.add_argument('--anno_file', type=str, default='vid_{}.json', help='the parsed vid annotation file')
parser.add_argument('--output_dir', type=str,
                    default='/home/jlzheng/dataset/tracking/usot/VID_{}', help='your vid output dir')
...
def crop_video(video, crop_path, instanc_size):
    ...
    for frame in video["frame"]:
        ...
        # Use the generated bbox in parse_vid_flow.py
