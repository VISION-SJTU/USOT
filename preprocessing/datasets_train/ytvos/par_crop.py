...
parser.add_argument('--input_dir', type=str, default='/data/dataset/youtube_vos', help='your ytvos data dir')
parser.add_argument('--anno_file', type=str, default='ytvos_{}.json', help='the parsed ytvos annotation file')
parser.add_argument('--output_dir', type=str,
                    default='/home/jlzheng/dataset/tracking/usot/ytvos_{}', help='your ytvos output dir')
...
ytvos_base_path = args.input_dir
...
def crop_video(video, crop_path, instanc_size):
    ...
    video_path_split = video['base_path'].split('/')
    video_file_base = join(ytvos_base_path, video_path_split[0], 'JPEGImages', video_path_split[1])
